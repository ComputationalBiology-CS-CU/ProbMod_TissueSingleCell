...
nohup ./lib/STAR/source/STAR  --sjdbGTFfile index_dir/index_22/gencode.v19.annotation.gtf --runMode genomeGenerate --runThreadN 8 --genomeDir index_dir/index_22 --genomeFastaFiles index_dir/index_22/chr22.fa > nohup.log &
